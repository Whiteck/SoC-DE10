...
_io = [
    ...
    ("clk100", 0, Pins("P11"), IOStandard("3.3-V LVTTL")),
    ...
    # Serial
    ("serial", 0,
        Subsignal("tx", Pins("AB17"), IOStandard("3.3-V LVTTL")), # JP1 GPIO[0]
        Subsignal("rx", Pins("AA17"), IOStandard("3.3-V LVTTL"))  # JP1 GPIO[1]
    ),
    ...
    # GPIOs
    #original definition of GPIOs, I switch theses pins into ports
    #if you don't call theses in your target files, a pins can have differents assignations
    ("gpio_0", 0, Pins(
    ...
    ("gpio_1", 0, Pins(
        "AB21 AA20 AB7 AB8 AB9 Y10 AA11 AA12 F16"),
        IOStandard("3.3-V LVTTL")
    ),
    #Raspberry

    #PORT RA = PINS between USB connector and 5v
    #full port = "V10 W10 V9 W9 V8 W8 V7 W7 W6 V5"
    ("port_RA", 0, Pins(
        "V10 W10 V9 W9 V8 W8 V7 W7 W6 V5"),
        IOStandard("3.3-V LVTTL")
    ),

    #PORT RB = PINS between the 5v and 3.3v 
    #full port = "W5 AA15 AA14 W13 W12 AB13 AB12 Y11" "AB11 W11 AB10 AA10 AA9 Y8 AA8 Y7"
    ("port_RB", 0, Pins(
        "W5 AA15 AA14 W13 W12 AB13 AB12 Y11",
        "AB11 W11 AB10 AA10 AA9 Y8 AA8 Y7"),
        IOStandard("3.3-V LVTTL")
    ...
    #PORT RC = PINS between 3.3V and vga connector
    #AB2 AA2 give to oscillo probe for debugging purposes
    #full port = "AA7 Y6 AA6 Y5 AA5 Y4 A3 Y3 AB2 AA2"
    ("port_RC", 0, Pins(
        "AA7 Y6 AA6 Y5 AA5 Y4 A3 Y3"),
        IOStandard("3.3-V LVTTL")
    ),
    # Arduino
    #PORT A = IO0 to IO7
    #AB5 AB6 give to I2C 
    #full port = "AB5 AB6 AB7 AB8 AB9 Y10 AA11 AA12"
    ("port_A", 0, Pins(
        "AB7 AB8 AB9 Y10 AA11 AA12"),
        IOStandard("3.3-V LVTTL")
    ),

    #PORT B = IO8 to IO15
    #AB17 AA17 give to Usb Uart 
    #AB19 AB20 AA19 Y19 give to SPI
    #full port = : "AB17 AA17 AB19 AA19 Y19 AB20 AB21 AA20"
    ("port_B", 0, Pins(
        "AB21 AA20"),
        IOStandard("3.3-V LVTTL")
    ),
    #SPI
    ("spi0", 0,
        Subsignal("clk", Pins("AB20"), IOStandard("3.3-V LVTTL")),
        Subsignal("cs_n", Pins("AB19"), IOStandard("3.3-V LVTTL")),
        Subsignal("mosi", Pins("AA19"), IOStandard("3.3-V LVTTL")),
        Subsignal("miso", Pins("Y19"), IOStandard("3.3-V LVTTL")) 
    ),

     #I2C
    ("i2c", 0,
        Subsignal("scl", Pins("AB5"), IOStandard("3.3-V LVTTL")),
        Subsignal("sda", Pins("AB6"), IOStandard("3.3-V LVTTL")) 
    ),

    #OSCILLO
    ("oscillo_probe_1", 0, Pins("AB2"), IOStandard("3.3-V LVTTL")), 
    ("oscillo_probe_2", 0, Pins("AA2"), IOStandard("3.3-V LVTTL")), 
